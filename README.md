...
Bundling: Compiled into a Linux-native binary using pkg to handle the /snapshot virtual filesystem.
Packaging: Compressed into a Type 2 AppImage using appimagetool.
Development Build
