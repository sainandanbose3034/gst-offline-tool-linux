...
csvImport.directive('ngCsvImport', ['$timeout', function($timeout) {
	return {
		restrict: 'E',
		transclude: true,
		replace: true,
		...
		link: function(scope, element, attrs, mainScope) {
			...
			element.on('change', function(onChangeEvent) {
                ...
                if(!FileSelectedcheck(scope.filename ,'.csv')){
                    alert('Selected File type is not allowed. Please upload csv files!');
                    $().blockPage(false);
//                     scope.createAlert("WarningOk", 'Selected File type is not allowed. Please upload csv files', function () {
